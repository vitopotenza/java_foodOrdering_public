...
import com.food.ordering.order.service.domain.port.output.repository.CustomerRepository;
import com.food.ordering.order.service.domain.port.output.repository.OrderRepository;
import com.food.ordering.order.service.domain.port.output.repository.RestaurantRepository;
...
public class OrderCreateCommandHandler {
    ...
    public CreateOrderResponse createOrder (CreateOrderCommand createOrderCommand){
        ...
        log.info("Order is creaated with id: {}", orderResult.getId().getValue());
